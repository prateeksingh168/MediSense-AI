          ...
          <div className="flex items-center gap-3 sm:gap-4">
            ...
            {emergencyCount > 0 && (
              <div
                ...
                title="Inspect Emergency cases in Doctor Command Center"
              >
            ...
            {/* Dual Portal Switcher (Patient vs Doctor) */}
            <div className="p-1 rounded-2xl bg-slate-100 border border-slate-200 flex items-center shadow-inner">
              <button
                ...
                className={`flex items-center gap-1.5 sm:gap-2 px-3.5 sm:px-4 py-2 rounded-xl text-xs sm:text-sm font-bold transition-all ${
              ...
              <button
                onClick={() => setActivePortal('doctor')}
                className={`relative flex items-center gap-1.5 sm:gap-2 px-3.5 sm:px-4 py-2 rounded-xl text-xs sm:text-sm font-bold transition-all ${
                  activePortal === 'doctor'
            ...
            <div className="flex items-center gap-2 sm:gap-3 pl-2 sm:pl-3 border-l border-slate-200">
              ...
              <button
                onClick={logoutUser}
                className="p-2 sm:px-3 sm:py-2 rounded-xl bg-slate-100 hover:bg-rose-50 text-slate-600 hover:text-rose-600 border border-slate-200 hover:border-rose-300 transition-all flex items-center gap-1.5 text-xs font-bold"
