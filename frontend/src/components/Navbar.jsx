              ...
              {!isDoctorRole ? (
                <>
                  ...
                  <button
                    ...
                    className="relative flex items-center gap-1.5 sm:gap-2 px-3 sm:px-3.5 py-2 rounded-xl text-xs sm:text-sm font-bold transition-all text-slate-600 hover:text-slate-900 cursor-pointer"
                    title="Medical Staff Authentication Required"
                  >
                ...
                <>
                  <button
                    ...
                    className={`flex items-center gap-1.5 sm:gap-2 px-3 sm:px-3.5 py-2 rounded-xl text-xs sm:text-sm font-bold transition-all cursor-pointer ${
                      activePortal === 'doctor'
                        ? 'bg-white text-indigo-700 shadow-sm border border-slate-200'
                        : 'text-slate-600 hover:text-slate-900'
                    }`}
                    title="My Individual Doctor Practice & Patients"
                  >
                  ...
                  <button
                    ...
                    title="Hospital Central Command • All Doctors & Total Patient Census"
                  >
                  ...
                  <button
                    onClick={() => setActivePortal('patient')}
                    className={`hidden md:flex items-center gap-1 px-2.5 py-2 rounded-xl text-xs font-bold transition-all cursor-pointer ${
                      activePortal === 'patient'
                        ? 'bg-white text-slate-900 shadow-sm border border-slate-200'
                        : 'text-slate-500 hover:text-slate-800'
                    }`}
                    title="Inspect Patient-Facing View"
                  >
